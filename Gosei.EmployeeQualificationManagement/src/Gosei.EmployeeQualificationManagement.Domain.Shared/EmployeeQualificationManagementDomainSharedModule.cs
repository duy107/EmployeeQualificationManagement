...
public class EmployeeQualificationManagementDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        EmployeeQualificationManagementGlobalFeatureConfigurator.Configure();
        EmployeeQualificationManagementModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<EmployeeQualificationManagementDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<EmployeeQualificationManagementResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/EmployeeQualificationManagement");

            options.DefaultResourceType = typeof(EmployeeQualificationManagementResource);
        ...
        {
            options.MapCodeNamespace("EmployeeQualificationManagement", typeof(EmployeeQualificationManagementResource));
        });
    }
}
