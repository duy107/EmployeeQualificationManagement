...
public class EmployeeQualificationManagementDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public EmployeeQualificationManagementDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
